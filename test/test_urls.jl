...
@testset "Construct markdown links" begin
    ...
    @test markdownImage(alpha, svc; w=250, caption="Iliad 1") == expectedCaption
end
...
@testset "Compose markdown for embedded image with link" begin
    ...
    actual = linkedMarkdownImage(ict, img, svc; w=150, caption="Folio 12 recto")
    @test actual == expected


    #@warn("actual is ###$(actual)###")
    #
    ...
    alpha = Cite2Urn("urn:cite2:hmt:vaimg.2017a:VA012RN_0013@0.2096,0.2112,0.1617,0.01892")
    alphaActual = linkedMarkdownImage(ict, alpha, svc; w=200, caption="Iliad 1")
